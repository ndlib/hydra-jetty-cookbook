...
default[:hydra_jetty][:port_number]   = '8983'
default[:hydra_jetty][:jetty_options] = '-XX:+CMSPermGenSweepingEnabled -XX:+CMSClassUnloadingEnabled -XX:PermSize=64M -XX:MaxPermSize=128M'
